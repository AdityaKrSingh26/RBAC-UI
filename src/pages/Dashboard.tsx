        ...
        <div className={`overflow-hidden rounded-lg ${
          ...
          <div className="p-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-4">
              ...
              <button className="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-100 px-4 py-2 text-sm font-medium text-indigo-700 shadow-sm hover:bg-indigo-200">
                Create New Role
              </button>
